...
copy /b loader.tap + mcload.tap + mcloader.tap + game_scr.tap + nirvanap.tap + game.tap + game_ay_1.tap game_ay_3.tap + game_ay_4.tap + game_ay_6.tap bin\game_release.tap 1>nul
...
FOR %%A IN ("game_BANK_1.bin.zx7") DO set LEN_BANK_1=%%~zA
...
echo defc LEN_BANK_1 = %LEN_BANK_1% >> zx7_game_sizes.asm
...
copy /b loader.tap + mcload.tap + mcloader.tap + game_scr.tap + nirvanap.tap + game.tap + game_ay_1.tap + game_ay_3.tap + game_ay_4.tap + game_ay_6.tap bin\game_release_zx7.tap 1>nul
